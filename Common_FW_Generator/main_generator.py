...
import cq_parameters_fw_x
import cq_parameters_fw_y
from cq_parameters_test import *
from cq_parameters_fw_x import *
from cq_parameters_fw_y import *

all_series = {
    'test':cq_parameters_test,
    'fw_x':cq_parameters_fw_x,
    'fw_y':cq_parameters_fw_y,
}
...
if __name__ == "temp":
    ...
    importlib.reload(cq_parameters_fw_x) # For debug reload
    importlib.reload(cq_parameters_fw_y) # For debug reload
