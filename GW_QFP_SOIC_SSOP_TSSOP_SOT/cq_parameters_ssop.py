...
pkg_defs = {
    'ETSSOP-20-1EP_4.4x6.5mm_Pitch0.65mm': Pkg_params( # from http://www.ti.com/lit/ds/symlink/lm5005.pdf
    ...
    'HTSSOP-14-1EP_4.4x5mm_P0.65mm_EP3.4x5mm_Mask3x3.1mm': Pkg_params( # Datasheet: http://www.ti.com/lit/ds/symlink/lm5161.pdf#page=34
    ...
    'HTSSOP-20-1EP_4.4x6.5mm_Pitch0.65mm_ThermalPad': Pkg_params( # from http://www.ti.com/lit/ml/mhts001g/mhts001g.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.09,             # pin upper corner, inner radius
    ...
    'HTSSOP-28_4.4x9.7mm_Pitch0.65mm_ThermalPad': Pkg_params( # from http://www.ti.com/lit/ml/mpds033b/mpds033b.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.09,             # pin upper corner, inner radius
    ...
    'MFSOP6-4_4.4x3.6mm_Pitch1.27mm': Pkg_params( # from https://toshiba.semicon-storage.com/ap-en/design-support/package/detail.4pin%20MFSOP6.html
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
    ...
    'MFSOP6-5_4.4x3.6mm_Pitch1.27mm': Pkg_params( # from https://toshiba.semicon-storage.com/ap-en/design-support/package/detail.5pin%20MFSOP6.html
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.05,            # pin upper corner, inner radius
    ...
    'MSOP-8_3x3mm_Pitch0.65mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081660_G_MS8.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.05,             # pin upper corner, inner radius
    ...
    'MSOP-8-1EP_3x3mm_Pitch0.65mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081662_K_MS8E.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
    ...
    'MSOP-10_3x3mm_Pitch0.5mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081661_F_MS.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.18,             # pin thickness, body center part height
        R1 = 0.05,             # pin upper corner, inner radius
    ...
    'MSOP-10-1EP_3x3mm_Pitch0.5mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081664_I_MSE.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.18,             # pin thickness, body center part height
        R1 = 0.05,             # pin upper corner, inner radius
    ...
    'MSOP-12_3x4mm_Pitch0.65mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081668_A_MS12.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.18,             # pin thickness, body center part height
        R1 = 0.05,             # pin upper corner, inner radius
    ...
    'MSOP-12-1EP_3x4mm_Pitch0.65mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081666_G_MSE12.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.18,             # pin thickness, body center part height
        R1 = 0.05,             # pin upper corner, inner radius
    ...
    'MSOP-16_3x4mm_Pitch0.5mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081669_A_MS16.pdf
        the = 12.0,           # body angle in degrees
    ...
    'MSOP-16-1EP_3x4mm_Pitch0.5mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081667_F_MSE16.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.1,          # top part of body is that much smaller
        c = 0.18,             # pin thickness, body center part height
        R1 = 0.05,             # pin upper corner, inner radius
    ...
    'MSOP-12-16_3x4mm_Pitch0.5mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081871_D_MSE16%2812%29.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.1,          # top part of body is that much smaller
        c = 0.18,             # pin thickness, body center part height
        R1 = 0.05,             # pin upper corner, inner radius
    ...
    'MSOP-12-16-1EP_3x4mm_Pitch0.5mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081871_D_MSE16%2812%29.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.1,          # top part of body is that much smaller
        c = 0.18,             # pin thickness, body center part height
        R1 = 0.05,             # pin upper corner, inner radius
    ...
    'PSOP-44_16.9x27.17mm_Pitch1.27mm': Pkg_params( # from http://pdf.datasheetcatalog.com/datasheet/macronix/MX29F800TMI-90.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
    ...
    'QSOP-16_3.9x4.9mm_Pitch0.635mm': Pkg_params( # from http://www.onsemi.com/pub/Collateral/492-01.PDF
        the = 12.0,           # body angle in degrees
        tb_s = 0.1,          # top part of body is that much smaller
        ...
        cc = 0.05,           # 0.45 chamfer of the other pin corners
        D1 = 4.9,             # body length
        E1 = 3.9,             # body width
    ...
    'QSOP-24_3.9x8.7mm_Pitch0.635mm': Pkg_params( # from http://www.onsemi.com/pub/Collateral/492B-01.PDF
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.22,             # pin thickness, body center part height
        R1 = 0.1,             # pin upper corner, inner radius
    ...
    'SOP-4_4.4x2.6mm_Pitch1.27mm': Pkg_params( # from http://www.vishay.com/docs/83510/tcmt1100.pdf#page=7
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
    ...
    'SOP-16_4.4x10.4mm_Pitch1.27mm': Pkg_params( # from http://www.vishay.com/docs/49447/49447.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.2,             # pin thickness, body center part height
        R1 = 0.1,             # pin upper corner, inner radius
    ...
    'SSOP-8_2.95x2.8mm_Pitch0.65mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds049b/mpds049b.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.1,             # pin upper corner, inner radius
    ...
    'SSOP-8_3.9x5.05mm_P1.27mm': Pkg_params( # from http://www.fujitsu.com/downloads/MICRO/fsa/pdf/products/memory/fram/MB85RS16-DS501-00014-6v0-E.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.1,           # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.1,             # pin upper corner, inner radius
    ...
    'SSOP-8_5.30x5.24mm_P1.27mm': Pkg_params( # from http://www.fujitsu.com/ca/en/Images/MB85RS2MT-DS501-00023-1v0-E.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.1,           # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.1,             # pin upper corner, inner radius
    ...
    'SSOP-8_3.95x5.21x3.27mm_Pitch1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds049b/mpds049b.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.1,          # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.1,             # pin upper corner, inner radius
    ...
    'SSOP-14_5.3x6.2mm_Pitch0.65mm': Pkg_params( # from http://www.ti.com/lit/ml/msso002e/msso002e.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
    ...
    'SSOP-16_3.9x4.9mm_Pitch0.635mm': Pkg_params( # from http://docs-asia.electrocomponents.com/webdocs/0156/0900766b80156779.pdf
        the = 12.0,           # body angle in degrees
    ...
    'SSOP-16_4.4x5.2mm_Pitch0.65mm': Pkg_params( # from http://www.onsemi.com/pub/Collateral/565AM.PDF
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.1,             # pin upper corner, inner radius
    ...
    'SSOP-16_5.3x6.2mm_Pitch0.65mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds507/mpds507.pdf
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.17,             # pin thickness, body center part height
        R1 = 0.1,             # pin upper corner, inner radius
    ...
    'SSOP-18_4.4x6.5mm_Pitch0.65mm': Pkg_params( # from https://toshiba.semicon-storage.com/us/design-support/package/detail.SSOP18-P-225-0.65.html
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.1,             # pin upper corner, inner radius
    ...
    'SSOP-20_4.4x6.5mm_Pitch0.65mm': Pkg_params( # from http://www.onsemi.com/pub/Collateral/565AM.PDF
        the = 12.0,           # body angle in degrees
        tb_s = 0.15,          # top part of body is that much smaller
        c = 0.15,             # pin thickness, body center part height
        R1 = 0.1,             # pin upper corner, inner radius
    ...
    'SSOP-20_5.3x7.2mm_Pitch0.65mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds508/mpds508.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SSOP-24_3.9x8.7mm_Pitch0.635mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081641_B_GN24.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.22,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SSOP-24_5.3x8.2mm_Pitch0.65mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds509/mpds509.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SSOP-28_5.3x10.2mm_Pitch0.65mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds509/mpds509.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.18,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SSOP-48_7.5x15.9mm_Pitch0.635mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds490/mpds490.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.18,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SSOP-56_7.5x18.5mm_Pitch0.635mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds491/mpds491.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSOP-I-48_12x18.4mm_Pitch0.5mm': Pkg_params( # from http://www.onsemi.com/pub/Collateral/950AD.PDF
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSOP-II-32_21.0x10.2mm_Pitch1.27mm': Pkg_params( # from http://www.topline.tv/drawings/pdf/TSOP-T2/TSOP32T50-T2.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-8_3x3mm_Pitch0.65mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT505-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-8_4.4x3mm_Pitch0.65mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT530-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-10_3x3mm_Pitch0.5mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT552-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-14_4.4x5mm_Pitch0.65mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT402-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-16_4.4x5mm_Pitch0.65mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT403-3.pdf
    ...
    'TSSOP-16-1EP_4.4x5mm_Pitch0.65mm': Pkg_params( # from http://www.onsemi.com/pub/Collateral/948AP.PDF
        the = 10.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-20_4.4x6.5mm_Pitch0.65mm': Pkg_params( # from http://www.onsemi.com/pub/Collateral/948AP.PDF
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-24_4.4x7.8mm_Pitch0.65mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT355-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-28_4.4x9.7mm_Pitch0.65mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT361-2.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-32_6.1x11mm_Pitch0.65mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT361-2.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-38_4.4x9.7mm_Pitch0.5mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT510-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-44_4.4x11.2mm_Pitch0.5mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds350b/mpds350b.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-48_6.1x12.5mm_Pitch0.5mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds350b/mpds350b.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'TSSOP-56_6.1x14mm_Pitch0.5mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT364-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'VSO-40_7.6x15.4mm_Pitch0.762mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT158-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.18,        # pin thickness, body center part height
    ...
    'VSO-56_11.1x21.5mm_Pitch0.75mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT190-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.18,        # pin thickness, body center part height
        R1 = 0.2,       # pin upper corner, inner radius
    ...
    'VSSOP-8_3.0x3.0mm_Pitch0.65mm': Pkg_params( # from http://www.ti.com/lit/ds/symlink/lm75b.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,      # top part of body is that much smaller
        c = 0.18,        # pin thickness, body center part height
        R1 = 0.05,       # pin upper corner, inner radius
		...
		'VSSOP-8_2.3x2mm_Pitch0.5mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT765-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.05,       # pin upper corner, inner radius
    ...
    'VSSOP-8_2.4x2.1mm_Pitch0.5mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT765-1.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.05,       # pin upper corner, inner radius
     ...
     'VSSOP-10_3x3mm_P0.5mm': Pkg_params( # from http://www.ti.com/lit/ds/symlink/ads1115.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.05,       # pin upper corner, inner radius
    ...
    'SOP-4_3.8x4.1mm_Pitch2.54mm': Pkg_params( # from http://www.ixysic.com/home/pdfs.nsf/www/CPC1017N.pdf/$file/CPC1017N.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.2,        # pin thickness, body center part height
    ...
    'HTSSOP-56-1EP_6.1x14mm_Pitch0.5mm': Pkg_params( # from http://www.ti.com/lit/ds/symlink/drv8301.pdf
        the = 12.0,      # body angle in degrees
        tb_s = 0.1,    # top part of body is that much smaller
        c = 0.15,        # pin thickness, body center part height
        R1 = 0.15,       # pin upper corner, inner radius
