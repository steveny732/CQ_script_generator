...
pkg_defs = {
    'TSSOP-30_6.1x9.7mm_P0.65mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-44_4.4x11mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-40_8x14mm_P0.65mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-52_8x11mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-28_6.1x7.8mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-50_4.4x12.5mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-28_8x9.7mm_P0.65mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-32_8x11mm_P0.65mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-56_8x14mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-36_4.4x7.8mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-36_8x9.7mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-28_6.1x9.7mm_P0.65mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-36_4.4x9.7mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-56_8x12.5mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-24_6.1x7.8mm_P0.65mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-52_6.1x11mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-60_8x12.5mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-64_6.1x14mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-40_8x11mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-36_6.1x7.8mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-48_8x9.7mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-80_6.1x17mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-36_6.1x9.7mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-48_8x12.5mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-40_6.1x14mm_P0.65mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-64_6.1x17mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-40_6.1x11mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-44_6.1x11mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-32_4.4x6.5mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-64_8x14mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-28_4.4x7.8mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-48_4.4x9.7mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-20_4.4x5mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-36_6.1x12.5mm_P0.65mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-36_8x12.5mm_P0.65mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-24_4.4x5mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-24_4.4x6.5mm_P0.5mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-48_6.1x9.7mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-56_6.1x12.5mm_P0.4mm': Pkg_params(
        #
...
#        dest_dir_prefix = '../Package_SO.3dshapes',      # destination directory
    ...
    'TSSOP-68_8x14mm_P0.4mm': Pkg_params(
        #
