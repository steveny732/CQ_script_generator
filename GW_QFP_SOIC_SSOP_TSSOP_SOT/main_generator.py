...
#!/usr/bin/python
#
# This is derived from a cadquery script for generating QFP models in 3D format.
#
# from https://bitbucket.org/hyOzd/freecad-macros                           *
# original author hyOzd                                                     *
# update to CadQuery2 author steveny732                                     *
#                                                                           *
...
## e.g. python main_generator.py series=qfp,soic                            *

## the script will generate STEP parametric models                          *
## to be used with KiCad                                                    *

#* These are a cadquery2 tools                                              *
...
__Comment__ = 'make GullWings ICs 3D models exported to STEP'
___ver___ = "1.4 12/03/2020"
...
from cq_parameters_qfp_maui import *
from cq_parameters_soic import *
from cq_parameters_soic_maui import *
from cq_parameters_sot import *
from cq_parameters_sot_maui import *
from cq_parameters_ssop import *
from cq_parameters_ssop_maui import *
from cq_parameters_tssop import *
from cq_parameters_tssop_maui import *
...
if __name__ == "temp":
    ...
    importlib.reload(cq_parameters_qfp) # For debug reload
...
if __name__ == "__main__" or __name__ == "main_generator":
    ...
    with open(build_log_file, 'w') as log:
        log.write('# Build report for gull wing packages 3d model genration\n')
