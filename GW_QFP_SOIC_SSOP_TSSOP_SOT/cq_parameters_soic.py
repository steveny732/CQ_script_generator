...
pkg_defs = {
	'SO-6L_10x3.84mm_Pitch1.27mm': Pkg_params( # TLP2770 https://toshiba.semicon-storage.com/info/docget.jsp?did=53548&prodName=TLP2770
	...
	'SO-20_12.8x7.5mm_Pitch1.27mm': Pkg_params( # SA605 https://www.nxp.com/docs/en/data-sheet/SA605.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.1,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SOIC-8_3.9x4.9mm_Pitch1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/msoi002j/msoi002j.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
    ...
    'SOIC-8-1EP_3.9x4.9mm_Pitch1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/msoi002j/msoi002j.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.2,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
	...
	'SOIC-8_5.275x5.275mm_P1.27mm': Pkg_params( # from http://ww1.microchip.com/downloads/en/DeviceDoc/20005045C.pdf#page=23
    ...
    'SOIC-14_3.9x8.7mm_Pitch1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds177g/mpds177g.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.2,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SOIC-14W_7.5x9.0mm_P1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds386/mpds386.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
    ...
    'SOIC-16_3.9x9.9mm_Pitch1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds178g/mpds178g.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.2,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SOIC-16W_7.5x10.3mm_Pitch1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/msoi003g/msoi003g.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.2,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SOIC-18W_7.5x11.6mm_Pitch1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds172a/mpds172a.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.2,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SOIC-20W_7.5x12.8mm_Pitch1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds173b/mpds173b.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.2,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SOIC-24W_7.5x15.4mm_Pitch1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds173b/mpds173b.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.2,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SOIC-28W_7.5x17.9mm_Pitch1.27mm': Pkg_params( # from http://www.ti.com/lit/ml/mpds175a/mpds175a.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.2,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'SOIJ-8_5.3x5.3mm_Pitch1.27mm': Pkg_params( # from http://ww1.microchip.com/downloads/en/PackagingSpec/00049AU.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
        c = 0.2,        # pin thickness, body center part height
        R1 = 0.1,       # pin upper corner, inner radius
    ...
    'ST_MultiPowerSO-30': Pkg_params( # from https://www.st.com/resource/en/datasheet/vnh5019a-e.pdf
        the = 9.0,      # body angle in degrees
        tb_s = 0.15,    # top part of body is that much smaller
    ...
    'HSOP-36-1EP_11.0x15.9mm_P0.65mm_SlugUp': Pkg_params(
        #
    ...
    'HSOP-8-1EP_3.9x4.9mm_P1.27mm_EP2.41x3.1mm': Pkg_params(
        #
    ...
    'HTSOP-8-1EP_3.9x4.9mm_P1.27mm_EP2.4x3.2mm': Pkg_params(
        #
    ...
    'TSSOP-16-1EP_4.4x5mm_Pitch0.65mm_EP3.4x5mm': Pkg_params(
        #
    ...
    'HTSSOP-20-1EP_4.4x6.5mm_P0.65mm_EP3.4x6.5mm_Mask2.75x3.43mm': Pkg_params(
        #
    ...
    'HTSSOP-24-1EP_4.4x7.8mm_P0.65mm_EP3.4x7.8mm_Mask2.4x4.68mm': Pkg_params(
        #
    ...
    'HTSSOP-32-1EP_6.1x11mm_P0.65mm_EP5.2x11mm': Pkg_params(
        #
    ...
    'HTSSOP-38-1EP_6.1x12.5mm_P0.65mm_EP5.2x12.5mm_Mask3.39x6.35mm': Pkg_params(
        #
    ...
    'Linear_MSOP-12-16-1EP_3x4mm_P0.5mm': Pkg_params(
        #
    ...
    'MSOP-12-16-1EP_3x4mm_Pitch0.5mm_EP1.65x2.85mm': Pkg_params(
        #
    ...
    'MSOP-16-1EP_3x4mm_Pitch0.5mm_EP1.65x2.85mm': Pkg_params(
        #
        # 10-Lead Plastic Micro Small Outline Package (MS) [MSOP] (see Microchip Packaging Specification 00000049BS.pdf)
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A2
    ...
    'MSOP-8-1EP_3x3mm_P0.65mm_EP2.54x2.8mm': Pkg_params(
        #
    ...
    'PowerIntegrations_eSOP-12B': Pkg_params(
        #
    ...
    'PowerIntegrations_SO-8': Pkg_params(
        #
    ...
    'PowerIntegrations_SO-8B': Pkg_params(
        #
    ...
    'PowerIntegrations_SO-8C': Pkg_params(
        #
        # Power-Integrations variant of 8-Lead Plastic Small Outline (SN) - Narrow, 3.90 mm Body [SOIC], see https://www.mouser.com/ds/2/328/linkswitch-pl_family_datasheet-12517.pdf
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A2
    ...
    'QSOP-20_3.9x8.7mm_P0.635mm': Pkg_params(
        #
    ...
    'SO-4_4.4x2.3mm_P1.27mm': Pkg_params(
        #
    ...
    'SO-4_4.4x3.6mm_P2.54mm': Pkg_params(
        #
    ...
    'SO-4_4.4x4.3mm_P2.54mm': Pkg_params(
        #
    ...
    'SO-4_7.6x3.6mm_P2.54mm': Pkg_params(
        #
    ...
    'SO-5_4.4x3.6mm_P1.27mm': Pkg_params(
        #
    ...
    'SO-6_4.4x3.6mm_P1.27mm': Pkg_params(
        #
    ...
    'SO-8_5.3x6.2mm_P1.27mm': Pkg_params(
        #
    ...
    'SOIC-16W-12_7.5x10.3mm_P1.27mm': Pkg_params(
        #
    ...
    'SOIC-16W_5.3x10.2mm_P1.27mm': Pkg_params(
        #
    ...
    'SOIC-16W_7.5x12.8mm_P1.27mm': Pkg_params(
        #
    ...
    'SOIC-28W_7.5x18.7mm_P1.27mm': Pkg_params(
        #
    ...
    'SOIC-8-N7_3.9x4.9mm_P1.27mm': Pkg_params(
        #
    ...
    'SOJ-36_10.16x23.49mm_P1.27mm': Pkg_params(
        #
    ...
    'SOP-16_7.5x10.4mm_P1.27mm': Pkg_params(
        #
    ...
    'SOP-18_7.0x12.5mm_P1.27mm': Pkg_params(
        #
    ...
    'SSO-6_6.8x4.6mm_P1.27mm_Clearance7mm': Pkg_params(
        #
    ...
    'SSO-6_6.8x4.6mm_P1.27mm_Clearance8mm': Pkg_params(
        #
        # 8-Lead Plastic Stretched Small Outline (SSO/Stretched SO), see https://docs.broadcom.com/cs/Satellite?blobcol=urldata&blobheader=application%2Fpdf&blobheadername1=Content-Disposition&blobheadername2=Content-Type&blobheadername3=MDT-Type&blobheadervalue1=attachment%3Bfilename%3DIPD-Selection-Guide_AV00-0254EN_030617.pdf&blobheadervalue2=application%2Fx-download&blobheadervalue3=abinary%253B%2Bcharset%253DUTF-8&blobkey=id&blobnocache=true&blobtable=MungoBlobs&blobwhere=1430884105675&ssbinary=true
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A2
    ...
    'SSO-8_13.6x6.3mm_P1.27mm_Clearance14.2mm': Pkg_params(
        #
        # 8-Lead Plastic Stretched Small Outline (SSO/Stretched SO), see https://docs.broadcom.com/cs/Satellite?blobcol=urldata&blobheader=application%2Fpdf&blobheadername1=Content-Disposition&blobheadername2=Content-Type&blobheadername3=MDT-Type&blobheadervalue1=attachment%3Bfilename%3DIPD-Selection-Guide_AV00-0254EN_030617.pdf&blobheadervalue2=application%2Fx-download&blobheadervalue3=abinary%253B%2Bcharset%253DUTF-8&blobkey=id&blobnocache=true&blobtable=MungoBlobs&blobwhere=1430884105675&ssbinary=true
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A2
    ...
    'SSO-8_6.8x5.9mm_P1.27mm_Clearance7mm': Pkg_params(
        #
        # 8-Lead Plastic Stretched Small Outline (SSO/Stretched SO), see https://docs.broadcom.com/cs/Satellite?blobcol=urldata&blobheader=application%2Fpdf&blobheadername1=Content-Disposition&blobheadername2=Content-Type&blobheadername3=MDT-Type&blobheadervalue1=attachment%3Bfilename%3DIPD-Selection-Guide_AV00-0254EN_030617.pdf&blobheadervalue2=application%2Fx-download&blobheadervalue3=abinary%253B%2Bcharset%253DUTF-8&blobkey=id&blobnocache=true&blobtable=MungoBlobs&blobwhere=1430884105675&ssbinary=true
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A2
    ...
    'SSO-8_6.8x5.9mm_P1.27mm_Clearance8mm': Pkg_params(
        #
        # 8-Lead Plastic Stretched Small Outline (SSO/Stretched SO), see https://docs.broadcom.com/cs/Satellite?blobcol=urldata&blobheader=application%2Fpdf&blobheadername1=Content-Disposition&blobheadername2=Content-Type&blobheadername3=MDT-Type&blobheadervalue1=attachment%3Bfilename%3DIPD-Selection-Guide_AV00-0254EN_030617.pdf&blobheadervalue2=application%2Fx-download&blobheadervalue3=abinary%253B%2Bcharset%253DUTF-8&blobkey=id&blobnocache=true&blobtable=MungoBlobs&blobwhere=1430884105675&ssbinary=true
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A2
    ...
    'SSO-8_9.6x6.3mm_P1.27mm_Clearance10.5mm': Pkg_params(
        #
        # 8-Lead Plastic Stretched Small Outline (SSO/Stretched SO), see https://docs.broadcom.com/cs/Satellite?blobcol=urldata&blobheader=application%2Fpdf&blobheadername1=Content-Disposition&blobheadername2=Content-Type&blobheadername3=MDT-Type&blobheadervalue1=attachment%3Bfilename%3DIPD-Selection-Guide_AV00-0254EN_030617.pdf&blobheadervalue2=application%2Fx-download&blobheadervalue3=abinary%253B%2Bcharset%253DUTF-8&blobkey=id&blobnocache=true&blobtable=MungoBlobs&blobwhere=1430884105675&ssbinary=true
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A2
    ...
    'SSOP-10_3.9x4.9mm_P1.00mm': Pkg_params(
        #
    ...
    'SSOP-20_3.9x8.7mm_P0.635mm': Pkg_params(
        #
    ...
    'SSOP-28_3.9x9.9mm_P0.635mm': Pkg_params(
        #
    ...
    'SSOP-32_11.305x20.495mm_P1.27mm': Pkg_params(
        #
    ...
    'SSOP-44_5.3x12.8mm_P0.5mm': Pkg_params(
        #
    ...
    'SSOP-8_3.9x5.05mm_P1.27mm': Pkg_params(
        #
    ...
    'SSOP-8_5.25x5.24mm_P1.27mm': Pkg_params(
        #
    ...
    'ST_PowerSSO-24_SlugDown': Pkg_params(
        #
    ...
    'ST_PowerSSO-24_SlugUp': Pkg_params(
        #
        # ST PowerSSO-24 1EP 7.5x10.3mm Pitch 0.8mm [JEDEC MO-271] (http://www.st.com/resource/en/datasheet/tda7266p.pdf, http://freedatasheets.com/downloads/Technical%20Note%20Powersso24%20TN0054.pdf)
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A2
    ...
    'ST_PowerSSO-36_SlugDown': Pkg_params(
        #
    ...
    'ST_PowerSSO-36_SlugUp': Pkg_params(
        #
        # ST PowerSSO-36 1EP 7.5x10.3mm Pitch 0.8mm [JEDEC MO-271] (http://www.st.com/resource/en/datasheet/tda7492p.pdf, http://freedatasheets.com/downloads/Technical%20Note%20Powersso24%20TN0054.pdf)
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A2
    ...
    'HTSOP-8-1EP_3.9x4.9mm_Pitch1.27mm': Pkg_params(
        #
    ...
    'Texas_HTSOP-8-1EP_3.9x4.9mm_P1.27mm_EP2.85x4.9mm_Mask2.4x3.1mm_ThermalVias': Pkg_params(
        #
    ...
    'TSOP-5_1.65x3.05mm_P0.95mm': Pkg_params(
        #
    ...
    'TSOP-6_1.65x3.05mm_P0.95mm': Pkg_params(
        #
    ...
    'TSOP-I-28_11.8x8mm_P0.55mm': Pkg_params(
        #
    ...
    'TSOP-I-32_11.8x8mm_P0.5mm': Pkg_params(
        #
    ...
    'TSOP-I-32_18.4x8mm_P0.5mm': Pkg_params(
        #
    ...
    'TSOP-I-48_18.4x12mm_P0.5mm': Pkg_params(
        #
    ...
    'TSOP-I-56_18.4x14mm_P0.5mm': Pkg_params(
        #
        # TSOP I, 32 pins, 18.4x8mm body (https://www.micron.com/~/media/documents/products/technical-note/nor-flash/tn1225_land_pad_design.pdf)
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A2
    ...
    'TSOP-II-44_10.16x18.41mm_P0.8mm': Pkg_params(
        #
    ...
    'TSOP-II-54_22.2x10.16mm_P0.8mm': Pkg_params(
        #
    ...
    'TSSOP-14-1EP_4.4x5mm_P0.65mm': Pkg_params(
        #
    ...
    'TSSOP-28_4.4x9.7mm_Pitch0.65mm': Pkg_params(
        #
    ...
    'TSSOP-30_4.4x7.8mm_P0.5mm': Pkg_params(
        #
    ...
    'TSSOP-38_6.1x12.5mm_P0.65mm': Pkg_params(
        #
