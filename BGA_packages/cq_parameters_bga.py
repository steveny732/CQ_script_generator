...
pkg_defs = {
    ...
    'BGA-16_4x4_1.92x1.92mm_Pitch0.5mm': Pkg_params( # from http://www.st.com/content/ccc/resource/technical/document/datasheet/group2/bc/cd/62/9e/8f/30/47/69/CD00151267/files/CD00151267.pdf/jcr:content/translations/en.CD00151267.pdf
    ...
    'BGA-25_5x5_6.35x6.35mm_Pitch1.27mm': Pkg_params( # from http://cds.linear.com/docs/en/datasheet/4624fc.pdf
        fp_r = 0.4,      # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0,# 0.05, # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-48_6x8_8.0x9.0mm_Pitch0.8mm': Pkg_params( # from https://www.xilinx.com/support/documentation/package_specs/fs48.pdf
        fp_r = 0.4,     # first pin indicator radius CHECED GOOD
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-64_10x10_9.0x9.0mm_Pitch0.8mm': Pkg_params( # from http://www.nxp.com/documents/outline_drawing/SOT926-1.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-68_5.0x5.0mm_Layout9x9_P0.5mm_Ball0.3mm_Pad0.25mm_NSMD': Pkg_params( # from https://www.intel.com/content/dam/www/programmable/us/en/pdfs/literature/packaging/04r00344-01.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-81_4.496x4.377mm_Layout9x9_P0.4mm_Ball0.25mm_Pad0.2mm_NSMD': Pkg_params( # from https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/packaging/04r00478-01.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-90_2x3x15_8.0x13.0mm_Pitch0.8mm': Pkg_params( # from http://www.issi.com/WW/pdf/42-45S32800J.pdf
        fp_r = 0.4,     # first pin indicator radius CHECKED GOOD
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-96_2x3x16_9.0x13.0mm_Pitch0.8mm': Pkg_params( # from http://www.mouser.com/ds/2/198/43-46TR16640B-81280BL-706483.pdf
        fp_r = 0.4,     # first pin indicator radius CHECKED GOOD
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-100_6.0x6.0mm_Layout11x11_P0.5mm_Ball0.3mm_Pad0.25mm_NSMD': Pkg_params( # from https://www.intel.com/content/dam/www/programmable/us/en/pdfs/literature/packaging/04r00345-01.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-100_10x10_9.0x9.0mm_Pitch0.8mm': Pkg_params( # from http://www.mouser.com/ds/2/198/43-46TR16640B-81280BL-706483.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-100_11.0x11.0mm_Layout10x10_P1.0mm_Ball0.5mm_Pad0.4mm_NSMD': Pkg_params( # from https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/packaging/04r00223-02.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-121_9.0x9.0mm_Layout11x11_P0.8mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081891_A_bga121.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-121_11x11_12.0x12.0mm_Pitch1.0mm': Pkg_params( # from http://cds.linear.com/docs/en/packaging/05081891_A_bga121.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-144_7.0x7.0mm_Layout13x13_P0.5mm_Ball0.3mm_Pad0.25mm_NSMD': Pkg_params( # from https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/packaging/04r00346-00.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-144_12x12_13.0x13.0mm_Pitch1.0mm': Pkg_params( # from http://www.topline.tv/drawings/pdf/BGA%201,0mm%20pitch/LBGA144T1.0-DC128.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-169_11.0x11.0mm_Layout13x13_P0.8mm_Ball0.5mm_Pad0.4mm_NSMD': Pkg_params( # from https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/packaging/04r00470-01.pdf
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-256_11.0x11.0mm_Layout20x20_P0.5mm_Ball0.3mm_Pad0.25mm_NSMD': Pkg_params( # from https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/packaging/04r00348-01.pdf
    ...
    'BGA-256_14.0x14.0mm_Layout16x16_P0.8mm_Ball0.45mm_Pad0.32mm_NSMD': Pkg_params( # from https://www.xilinx.com/support/documentation/package_specs/ft256.pdf
        fp_r = 0.8,     # first pin indicator radius
        fp_d = 0.12,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-256_16x16_17.0x17.0mm_Pitch1.0mm': Pkg_params( # from https://www.intersil.com/content/dam/Intersil/documents/v256/v256.17x17.pdf
        fp_r = 0.8,     # first pin indicator radius
        fp_d = 0.12,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-324_19.0x19.0mm_Layout18x18_P1.0mm_Ball0.5mm_Pad0.4mm_NSMD': Pkg_params( # from https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/packaging/04r00474-02.pdf
        fp_r = 0.8,     # first pin indicator radius
        fp_d = 0.12,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-400_20x20_17.0x17.0mm_Pitch0.8mm': Pkg_params( # from https://www.xilinx.com/support/documentation/user_guides/ug865-Zynq-7000-Pkg-Pinout.pdf
    ...
    'BGA-624_25x25_21.0x21.0mm_Pitch0.8mm': Pkg_params( # from https://www.nxp.com/docs/en/package-information/SOT1529-1.pdf
        fp_r = 0.5,     # first pin indicator radius
        fp_d = 0.12,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-1023_32x32_33.0x33.0mm_Pitch1.0mm': Pkg_params( # from https://www.idt.com/document/psc/hmrm-1023-package-outline-33-x-33-mm-body-100-mm-pitch-fcbga IDT_PSC-4260.pdf
        ...
        ct1 = 0.8,      #0.5 chamfer of the 1st pin corner
        ct = 0.5,      #0.5 chamfer of the others corner
    ...
    'BGA-1156_34x34_35.0x35.0mm_Pitch1.0mm': Pkg_params( # from https://www.xilinx.com/support/documentation/package_specs/pk401_FF_G_1156.pdf
        fp_r = 1.0,     # first pin indicator radius
        fp_d = 0.25,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0    ,   # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
        ct1 = 0.7,      # 0.5 chamfer of the 1st pin corner
        ct = 0.2,       # 0.5 chamfer of the others corner
    ...
    'BGA-1295_36x36_37.5x37.5mm_Pitch1.0mm': Pkg_params( # from http://www.datasheets360.com/pdf/6857809988541063510
        fp_r = 2.0,     # first pin indicator radius
        fp_d = 0.5,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.1    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
        ct1 = 0.4,      #0.5 chamfer of the 1st pin corner
        ct = 0.2,      #0.5 chamfer of the others corner
    ...
    'DSBGA-8_2x4_0.9x1.9mm_Pitch0.5mm_Dia0.25mm': Pkg_params( # from http://www.ti.com/lit/ds/symlink/txb0102.pdf
        fp_r = 0.15,     # first pin indicator radius CHECKED GOOD
    ...
    'DSBGA-12_3x4_1.36x1.86mm_Pitch0.5mm': Pkg_params( # from http://www.ti.com/lit/ds/symlink/txb0104.pdf
        fp_r = 0.3,     # first pin indicator radius CHECK GOOD
        fp_d = 0.01,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'LFBGA-100_10x10mm_Layout10x10_P0.8mm': Pkg_params( # from http://www.st.com/resource/en/datasheet/stm32f103tb.pdf page 87
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'LFBGA-144_10x10mm_Layout12x12_P0.8mm': Pkg_params( # from http://www.st.com/resource/en/datasheet/stm32f103ze.pdf page 114
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'Linear_BGA-133_15.0x15.0_Layout12x12_P1.27mm': Pkg_params( # from https://www.analog.com/media/en/technical-documentation/data-sheets/4637fc.pdf page 28
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0    , # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'Texas_DSBGA-49_3.33x3.488mm_Layout7x7_P0.4mm': Pkg_params( # from http://www.ti.com/lit/ds/symlink/msp430f2234.pdf page 90
        fp_r = 0.3,     # first pin indicator radius
        fp_d = 0.01,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'Texas_MicroStar_Junior_BGA-80_5.0x5.0mm_Layout9x9_P0.5mm': Pkg_params( # from http://www.ti.com/lit/ds/symlink/tlv320aic23b.pdf
        fp_r = 0.3,     # first pin indicator radius
        fp_d = 0.01,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'Texas_MicroStar_Junior_BGA-113_7.0x7.0mm_Layout12x12_P0.5mm': Pkg_params( # from http://www.ti.com/lit/ml/mpbg674/mpbg674.pdf
        fp_r = 0.3,     # first pin indicator radius
        fp_d = 0.01,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'Texas_Junior_DSBGA-48': Pkg_params( # from http://www.ti.com/lit/ml/mpbg309/mpbg309.pdf
        fp_r = 0.3,     # first pin indicator radius
        fp_d = 0.01,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'TFBGA-64_5x5mm_Layout8x8_P0.5mm': Pkg_params( # from http://www.st.com/resource/en/datasheet/stm32f100v8.pdf page 83
        fp_r = 0.5,     # first pin indicator radius
        fp_d = .2,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
        D = 5.00,      # body overall length
        E = 5.00,      # body overall width
    ...
    'TFBGA-100_8x8mm_Layout10x10_P0.8mm': Pkg_params( # from http://www.st.com/resource/en/datasheet/stm32f746zg.pdf
        fp_r = 0.5,     # first pin indicator radius
        fp_d = .2,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'TFBGA-100_9.0x9.0mm_Layout10x10_P0.8mm': Pkg_params( # from 
        fp_r = 0.5,     # first pin indicator radius
        fp_d = .2,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'TFBGA-121_10x10mm_Layout11x11_P0.8mm': Pkg_params( # from http://ww1.microchip.com/downloads/en/PackagingSpec/00000049BQ.pdf#p495 
        fp_r = 0.5,     # first pin indicator radius
        fp_d = .2,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'TFBGA-216_13x13mm_Layout15x15_P0.8mm': Pkg_params( # from http://www.st.com/resource/en/datasheet/stm32f746zg.pdf page 219
        fp_r = 0.5,     # first pin indicator radius
        fp_d = .2,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'TFBGA-265_14x14mm_Layout17x17_P0.8mm': Pkg_params( # from
        fp_r = 0.5,     # first pin indicator radius
        fp_d = .2,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0, 		# 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'TFBGA-636_19.0x19.0mm_Layout28x28_P0.65mm': Pkg_params( # from
        fp_r = 0.5,     # first pin indicator radius
        fp_d = .2,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0,       # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'FBGA-78_7.5x11mm_Layout2x3x13_P0.8mm': Pkg_params( # from https://www.skhynix.com/product/filedata/fileDownload.do?seq=7687
        fp_r = 0.5,     # first pin indicator radius CHECKED GOOD
        fp_d = .2,      # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
    ...
    'ucBGA-49_3x3mm_Layout7x7_P0.4mm': Pkg_params( #https://www.latticesemi.com/view_document?document_id=213
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0, # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'ucBGA-36_2.5x2.5mm_Layout6x6_P0.4mm': Pkg_params( #https://www.latticesemi.com/view_document?document_id=213
        fp_r = 0.4,     # first pin indicator radius
        fp_d = 0.08,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        ef = 0.0, # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'WLP-4_0.83x0.83mm_P0.4mm': Pkg_params( #https://pdfserv.maximintegrated.com/package_dwgs/21-100107.PDF
    ...
    'WLP-4_0.86x0.86mm_P0.4mm': Pkg_params( #https://pdfserv.maximintegrated.com/package_dwgs/21-0612.PDF
        fp_r = 0.2,     # first pin indicator radius
        fp_d = 0.02,    # first pin indicator distance from edge
        fp_z = 0.01,    # first pin indicator depth
        ef = 0.0,       # 0.05,      # fillet of edges  Note: bigger bytes model with fillet
    ...
    'BGA-36_3.396x3.466mm_Layout6x6_P0.4mm_Ball0.25mm_Pad0.2mm_NSMD': Pkg_params(
        #
    ...
    'BGA-484_22x22_23.0x23.0mm_Pitch1.0mm': Pkg_params( # from https://www.xilinx.com/support/documentation/package_specs/fg484.pdf
        fp_r = 0.8,      # first pin indicator radius
        fp_d = 0.14,     # first pin indicator distance from edge
        fp_z = 0.01,     # first pin indicator depth
        the2 = 30.,      # angle of top
        cb1 = 0.,        # 0.5 chamfer of the 1st pin corner
        cb = -0.5,      # 0.5 chamfer of the others corner
        tp_tct = typ_cham,  # top corner type
        ct1 = 1.5,        # 0.5 chamfer of the 1st pin corner
        ct = 2.,         # 0.5 chamfer of the others corner
        ...
        excluded_pins = ("internals",), #"internals", #pins to exclude -> None or "internals"
        body_color_key = "green body",          # bottom body color
        body_top_color_key = "black body",      # top body color
        pins_color_key = "gold pins",           # pins color
        mark_color_key = "light brown label",   # marker color
    ...
    'BGA-672_27.0x27.0mm_Layout26x26_P1.0mm_Ball0.6mm_Pad0.5mm_NSMD': Pkg_params(
        #
    ...
    'BGA-676_27.0x27.0mm_Layout26x26_P1.0mm_Ball0.6mm_Pad0.5mm_NSMD': Pkg_params(
        #
    ...
    'Texas_DSBGA-64_3.415x3.535mm_Layout8x8_P0.4mm': Pkg_params(
        #
    ...
    'Texas_DSBGA-8_1.43x1.41mm_Layout3x3_P0.5mm': Pkg_params(
        #
    ...
    'Texas_DSBGA-9_1.4715x1.4715mm_Layout3x3_P0.5mm': Pkg_params(
        #
    ...
    'UCBGA-81_4x4mm_Layout9x9_P0.4mm': Pkg_params(
        #
    ...
    'UFBGA-100_7x7mm_Layout12x12_P0.5mm': Pkg_params(
        #
    ...
    'UFBGA-132_7x7mm_Layout12x12_P0.5mm': Pkg_params(
        #
    ...
    'UFBGA-132_7x7mm_P0.5mm': Pkg_params(
        #
    ...
    'UFBGA-144_10x10mm_Layout12x12_P0.8mm': Pkg_params(
        #
    ...
    'UFBGA-144_7x7mm_Layout12x12_P0.5mm': Pkg_params(
        #
    ...
    'UFBGA-15_3.0x3.0mm_Layout4x4_P0.65mm': Pkg_params(
        #
    ...
    'UFBGA-169_7x7mm_Layout13x13_P0.5mm': Pkg_params(
        #
    ...
    'UFBGA-201_10x10mm_Layout15x15_P0.65mm': Pkg_params(
        #
    ...
    'UFBGA-32_4.0x4.0mm_Layout6x6_P0.5mm': Pkg_params(
        #
    ...
    'UFBGA-64_5x5mm_Layout8x8_P0.5mm': Pkg_params(
        #
    ...
    'VFBGA-100_7.0x7.0mm_Layout10x10_P0.65mm': Pkg_params(
        #
    ...
    'VFBGA-49_5.0x5.0mm_Layout7x7_P0.65mm': Pkg_params(
        #
    ...
    'XFBGA-121_8x8mm_Layout11x11_P0.65mm': Pkg_params(
        #
    ...
    'XFBGA-36_3.5x3.5mm_Layout6x6_P0.5mm': Pkg_params(
        #
    ...
    'XFBGA-64_5.0x5.0mm_Layout8x8_P0.5mm': Pkg_params(
        #
    ...
    'WLCSP-143,_5.849x4.539mm_Layout13x11_P0.4mm': Pkg_params(
        #
        # WLCSP-143, 11x13 raster, 4.539x5.849mm package, pitch 0.4mm; www.st.com/resource/en/datasheet/stm32f446ze.pdf
        # This model have been auto generated based on the foot print file
        # A number of paramters have been fixed or guessed, such as A and A1
        # 
