...
__author__ = "maurice"
__Comment__ = 'CadQuery exporting and fusion libs to generate STEP models with colors'
    ...
    if '-' in string:
        if len(string.split('-')) == 2:
            ...
            try:
                ...
                print("Error in getListOfNumbers range case:")
                print('{:s}\n'.format(exp))
        ...
        for s in ss:
            try:
                ...
                print("Error in getListOfNumbers list case:")
                print('{:s}\n'.format(exp))
        ...
        try:
            ...
            print("Error in getListOfNumbers single number case:")
            print('{:s}\n'.format(exp))
...
#    except Exception as exp:
#        print("Error while trying to remove backup file in saveFCdoc:")
#        print('{:s}\n'.format(str(exp)))
#    if saving == False:
#        try:
#            os.remove(outdir+os.sep+modelName+'.FCStd') #removing project file
#        except Exception as exp:
#            print("Error while trying to remove file in saveFCdoc (with save == False):")
#            print('{:s}\n'.format(exp))
#    else:
